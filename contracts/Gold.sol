...
contract VoxelVerseGold is ERC1155, Ownable, Pausable, ERC1155Burnable, ERC1155Supply {
    ...
    function burnGold(address user, uint256 amount) external {
        // Burn the wood token
        require(balanceOf(user, 4) > 0, "You don't any stone to burn!");
